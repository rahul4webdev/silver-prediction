...
export default function Navigation() {
  ...
  return (
    <>
      <nav className="glass-card mx-2 sm:mx-4 mt-2 sm:mt-4 px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
        {/* Logo */}
        <Link href="/" className="flex items-center gap-2 sm:gap-3">
          <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg sm:rounded-xl bg-gradient-to-br from-cyan-400 to-blue-500 flex items-center justify-center flex-shrink-0">
      ...
      <div className={`mobile-nav-menu lg:hidden ${isOpen ? 'open' : ''}`}>
        <div className="p-4">
